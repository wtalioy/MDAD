...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="phonecall", help="Name of the dataset", choices=list(DATASET_MAP.keys()))
    parser.add_argument("--subset", type=str, default="zh-cn", help="Subset of the dataset", choices=["en", "zh-cn"])
